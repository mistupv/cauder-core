...
setupMenu() ->
  ...
  wxMenuItem:setHelp(OpenItem,     "Open and compile an Erlang file"),
  wxMenuItem:setHelp(QuitItem,     "Quit this program"),
  wxMenuItem:setHelp(ZoomInItem,   "Increase text font size"),
  wxMenuItem:setHelp(ZoomOutItem,  "Decrease text font size"),
  wxMenuItem:setHelp(ToggleMail,   "Show or hide process mailboxes"),
  wxMenuItem:setHelp(ToggleHist,   "Show or hide process histories"),
  wxMenuItem:setHelp(ToggleEnv,    "Show or hide process environments"),
  wxMenuItem:setHelp(ToggleExp,    "Show or hide process expressions"),
  wxMenuItem:setHelp(RadioConc,    "Show only concurrent history"),
  wxMenuItem:setHelp(RadioFull,    "Show complete history"),
  wxMenuItem:setHelp(RadioRelEnv,  "Show relevant bindings from environment"),
  wxMenuItem:setHelp(RadioFullEnv, "Show all bindings from environment"),
  wxMenuItem:setHelp(ToggleComp,   "Allow compiler optimizations when loading files"),
  wxMenuItem:setHelp(RadioRand,    "Set scheduler to random choice among options"),
  wxMenuItem:setHelp(RadioPrio,    "Set scheduler to random choice among options (priority to process options)"),
